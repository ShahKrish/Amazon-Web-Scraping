...
Original file is located at
    https://colab.research.google.com/drive/1SOUWQTyjkcHiYJqknQ3AoLqRC6OV_JGi
"""
...
if __name__ == '__main__':
    ...
    for link in links:
            final_link = "https://www.amazon.com" + link.get("href")
            links_list.append(final_link)


    d = {"URL":[], "Name":[], "Price":[], "Rating":[],"No of Reviews":[]}
